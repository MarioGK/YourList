...
namespace YourList.Internal
{
    internal class SegmentedHttpStream : Stream
    {
        ...
        [ExcludeFromCodeCoverage] public override bool CanSeek => true;

        [ExcludeFromCodeCoverage] public override bool CanWrite => false;
        ...
        {
            return Position = GetNewPosition(offset, origin);
        }
