...
namespace YourList.Playlists
{
    ...
    public partial struct PlaylistId : IEquatable<PlaylistId>
    {
        ...
        {
            return obj is PlaylistId other && Equals(other);
        }
    ...
    public partial struct PlaylistId
    {
        ...
        /// </summary>
        public static implicit operator PlaylistId(string idOrUrl)
        {
            return new PlaylistId(idOrUrl);
        }
    ...
    public partial struct PlaylistId
    {
        ...
        private static string? TryNormalize(string? idOrUrl)
        {
            ...
            var embedCompositeMatch =
                Regex.Match(idOrUrl, @"youtube\..+?/embed/.*?/.*?list=(.*?)(?:&|/|$)").Groups[1].Value;
        ...
        {
            return TryNormalize(idOrUrl)?.Pipe(id => new PlaylistId(id));
        }
    }
}