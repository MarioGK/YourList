...
namespace YourList
{
    ...
    public static class AccessibilityExtensions
    {
        ...
        /// </summary>
        public static async ValueTask<IReadOnlyList<Video>> BufferAsync(
            this IAsyncEnumerable<Video> asyncVideoEnumerable) =>
        ...
        /// </summary>
        public static async ValueTask<IReadOnlyList<Video>> BufferAsync(
            this IAsyncEnumerable<Video> asyncVideoEnumerable, int count) =>
        ...
        /// </summary>
        public static ValueTaskAwaiter<IReadOnlyList<Video>> GetAwaiter(
            this IAsyncEnumerable<Video> asyncVideoEnumerable) =>
