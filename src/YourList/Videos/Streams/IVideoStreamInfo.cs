...
namespace YourList.Videos.Streams
{
    ...
    public static class VideoStreamInfoExtensions
    {
        ...
        {
            return streamInfos.Select(s => s.VideoQuality).ToHashSet();
        }
        ...
        {
            return streamInfos.Select(s => s.VideoQualityLabel).ToHashSet();
        }
        ...
        {
            return streamInfos.OrderByDescending(s => s.VideoQuality).ThenByDescending(s => s.Framerate)
                .FirstOrDefault();
        }
    }
}